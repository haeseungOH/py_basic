...
print('모델 작성방법 2 : function api : 유연한 구조. 입력 데이터로 여러 층을 고유하거나 다양한 종류의 입출력 사용이 가능')
...
from sklearn.metrics import r2_score
print('설명력 2: ', r2_score(y_data, model2.predict(x_data)))
print('실제값 2: ', y_data)
print('예측값 2: ', model2.predict(x_data).flatten())
...
from sklearn.metrics import r2_score
print('설명력 3: ', r2_score(y_data, model3.predict(x_data)))
...
from sklearn.metrics import r2_score
print('설명력 3: ', r2_score(y_data, model4.predict(x_data)))
