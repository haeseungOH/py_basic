# 다중선선형회귀 : 주식 데이터로 회귀모델 작성. 하루 전 데이터로 다음날 종가 예측 
...
print('r2_score : ', r2_score(y_data, pred))  # 0.964878485  과적합? 의심스러움
...
print('split after - r2_score : ', r2_score(y_test, pred2))  # 0.789354  과적합? 의심 해제 ㅎㅎ
