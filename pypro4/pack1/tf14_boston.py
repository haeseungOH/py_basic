...
print('설명력 : ', r2_score(y_test, model.predict(x_test)))    # 0.7281
"""
print('--------------------' * 10)
# concatenate : numpy 배열 결합
a = np.array([[1,2],[3,4]])         # 2 by 2 
b = np.array([[5,6],[7,8],[9,10]])  # 3 by 2
...
for i in range(k):
    ...
    val_x = x_train[i * val_samples:(i+1)*val_samples]
    ...
    print('mse history2 : ', mse_history2)
    val_history2 = history2.history['val_mse']
    print('val history2 : ', val_history2)
