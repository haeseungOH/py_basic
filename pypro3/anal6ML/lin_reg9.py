...
print('회귀계수(intercept) : ', lmodel.intercept_)  # y 절편 30.098860539622496
...
print('%s 마력인 경우 예상연비는 약 %s입니다.'%(new_hp[0][0], new_pred[0])) # 110 마력인 경우 예상연비는 약 22.593749951750496입니다.
