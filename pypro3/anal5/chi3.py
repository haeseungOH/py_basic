...
#print(chi_result)
#chi2, p, ddof, _ = stats.chi2_contingency(chi_result)    # 바로 ctab 사용해도 된다.
...
na_table['count_la'] = la_table['count']    # na_table에 la_table 'count' 합치기
print()
print(na_table)
 
chi2, p, df, _ = stats.chi2_contingency(na_table)
print('chi2:{}, p:{}, df:{}'.format(chi2,p,df)) 
# 해석 : p:0.0011800 < 0.05 이므로 귀무 귀각.
