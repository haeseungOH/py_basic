# ROC curve : ROC(Receiver Operating Characteristic) curve는 다양한 threshold에 대한 이진분류기의 성능을 한번에 표시한 것이다.
...
print('--------------'*10)
f_value = model.decision_function(x)  # 결정하수 (판별함수) : 불확실성 추정함수 - 판별 경계선 설절을 위함 
...
print('acc(정확도) : ', acc)           # acc(정확도) :  0.88
